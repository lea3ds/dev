...
namespace SaleWebApi.Controllers.Resources
{
    public class IncomePendingResource
    {
        ...
        public static IncomePendingResource ToResource(IncomePending obj)
        {
        ...
        public static IncomePending ToEntity(IncomePendingResource obj)
        {
            if (obj == null) return null;
            var res = new IncomePending
            {
                id = obj.id,
