...
namespace Sale.WebApi.Controllers.Resources
{
    public class PaymentResource
    {
        ...
        public static PaymentResource ToResource(DataAccess.Payment obj)
        {
        ...
        public static DataAccess.Payment ToEntity(PaymentResource  obj)
        {
            if (obj == null) return null;
            var res = new DataAccess.Payment
            {
                id = obj.id,
